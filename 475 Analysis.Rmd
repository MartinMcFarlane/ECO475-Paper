...
ggplot(prov.ests, aes(x=factor(prov, provs), y=fit, fill=year)) +
...
## Plot bars with conf intervals
ggplot(pop.ests, aes(x=factor(pop.bin, pop_order), y=fit, fill=year)) +
...
vars.of.int <- c("pop_dens", "married", "marr_w_child", "unafford.pc", "cov19aid.pc",
