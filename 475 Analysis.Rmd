...
ggplot(prov.ests, aes(x=prov, y=fit, fill=year)) +
...
## Plot bars with conf intervals
ggplot(pop.ests, aes(x=pop.bin, y=fit, fill=year)) +
  geom_bar(stat="identity", position="dodge") +
...
r.se1 <- vcovHC(m1, type="HC0") %>% diag() %>% sqrt()
...
r.se2 <- vcovHC(m2, type="HC0") %>% diag() %>% sqrt()
...
r.se3 <- vcovHC(m3, type="HC0") %>% diag() %>% sqrt()
...
r.se4 <- vcovHC(m4, type="HC0") %>% diag() %>% sqrt()
...
r.se5 <- vcovHC(m5, type="HC0") %>% diag() %>% sqrt()
...
r.se6 <- vcovHC(m6, type="HC0") %>% diag() %>% sqrt()
...
r.se7 <- vcovHC(m7, type="HC0") %>% diag() %>% sqrt()
...
r.se8 <- vcovHC(m8, type="HC0") %>% diag() %>% sqrt()
...
r.se9 <- vcovHC(m9, type="HC0") %>% diag() %>% sqrt()
...
hist.d %>% ggplot(aes(x=unafford.pc)) + 
  ...
  ggtitle("Unaffordable Housing Distribution, Total Sample")

hist.d <- df.no.nas[(df.no.nas$Tenure == "Owner") | (df.no.nas$Tenure == "Renter"),]
hist.d %>% ggplot(aes(x=unafford.pc, fill=Tenure)) + geom_histogram(alpha=0.6, position="identity") + ggtitle("Unaffordable Housing Distribution, Owner & Renter")

## Unsuitable housing
hist.d <- df.no.nas[(df.no.nas$Tenure == "Total"),]
hist.d %>% ggplot(aes(x=unsuit.pc)) + 
  geom_histogram(position="identity", fill="orange") + 
  ggtitle("Unsuitable Housing Distribution, Total Sample")

hist.d <- df.no.nas[(df.no.nas$Tenure == "Owner") | (df.no.nas$Tenure == "Renter"),]
hist.d %>% ggplot(aes(x=unsuit.pc, fill=Tenure)) + geom_histogram(alpha=0.6, position="identity") + ggtitle("Unsuitable Housing Distribution, Owner & Renter")

## Inadequate housing
hist.d <- df.no.nas[(df.no.nas$Tenure == "Total"),]
hist.d %>% ggplot(aes(x=inadq.pc)) + 
  geom_histogram(position="identity", fill="orange") + 
  ggtitle("Inadequate Housing Distribution, Total Sample")

hist.d <- df.no.nas[(df.no.nas$Tenure == "Owner") | (df.no.nas$Tenure == "Renter"),]
hist.d %>% ggplot(aes(x=inadq.pc, fill=Tenure)) + geom_histogram(alpha=0.6, position="identity") + ggtitle("Inadequate Housing Distribution, Owner & Renter")
