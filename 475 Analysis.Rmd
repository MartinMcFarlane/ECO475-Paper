...
model.tot1 <- full.df[full.df$Tenure == "Total",] %>% lm(formula = unafford.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k)
summary(model.tot1)
```

```{r}
# Rerun restricting to 2021 sample
model.tot2021 <- full.df[(full.df$Tenure == "Total") & (full.df$Year == 2021),] %>% lm(formula = unafford.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k)
...
hist(housing.w$unafford.pc) # need to separate by tenure type
