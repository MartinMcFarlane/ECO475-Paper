...
#### Total, w/ controls and population weights
m3 <- df.no.nas[(df.no.nas$Tenure == "Total"),] %>% 
  lm(formula = unafford.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k + time +
       time*pop_bel_1k + time*pop_1k_2.5k + time*pop_2.5k_10k + time*pop_10k_50k + time*pop_50k_200k +
       med_at_inc + bel_lico + non_cdn + he_highschool + he_postsec + unemp + married +
       marr_w_child + age_15to24 + age_25to34 + age_35to44 + age_45to54 + age_55to64 +
       age_65to74 + age_75to84 + age_85_plus + factor(prov), weights=pop21)
...
#### Owner, w/ controls and population weights
...
#### Renter, w/ controls and pop weights
...
#### Total, no controls
m1 <- df.no.nas[(df.no.nas$Tenure == "Total"),] %>% 
  lm(formula = unsuit.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k + time +
       time*pop_bel_1k + time*pop_1k_2.5k + time*pop_2.5k_10k + time*pop_10k_50k + time*pop_50k_200k)
...
#### Total, no controls
m1 <- df.no.nas[(df.no.nas$Tenure == "Total"),] %>% 
  lm(formula = inadq.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k + time +
       time*pop_bel_1k + time*pop_1k_2.5k + time*pop_2.5k_10k + time*pop_10k_50k + time*pop_50k_200k)
...
hist.d %>% ggplot(aes(x=unafford.pc)) + 
  ...
  ggtitle("Distribution, Total Sample")

hist.d <- df.no.nas[(df.no.nas$Tenure == "Owner") | (df.no.nas$Tenure == "Renter"),]
hist.d %>% ggplot(aes(x=unafford.pc, fill=Tenure)) + geom_histogram(alpha=0.6, position="identity") + ggtitle("Distribution, Owner & Renter")
