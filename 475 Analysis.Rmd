...
```{r}
### TABLE 1: Change over time of indicators
#### Total, no controls
ml.tot1 <- df.no.nas[(df.no.nas$Tenure == "Total"),] %>% 
  lm(formula = unafford.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k + time +
       time*pop_bel_1k + time*pop_1k_2.5k + time*pop_2.5k_10k + time*pop_10k_50k + time*pop_50k_200k)

#### Total, w/ controls
ml.tot2 <- df.no.nas[(df.no.nas$Tenure == "Total"),] %>% 
  lm(formula = unafford.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k + time +
       time*pop_bel_1k + time*pop_1k_2.5k + time*pop_2.5k_10k + time*pop_10k_50k + time*pop_50k_200k +
       med_at_inc + bel_lico + non_cdn + he_highschool + he_postsec + unemp + married +
       marr_w_child + age_15to24 + age_25to34 + age_35to44 + age_45to54 + age_55to64 +
...
#### Owner, no controls
ml.own1 <- df.no.nas[(df.no.nas$Tenure == "Owner"),] %>% 
  lm(formula = unafford.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k + time +
       time*pop_bel_1k + time*pop_1k_2.5k + time*pop_2.5k_10k + time*pop_10k_50k + time*pop_50k_200k)

#### Owner, w/ controls
ml.own2 <- df.no.nas[(df.no.nas$Tenure == "Owner"),] %>% 
  lm(formula = unafford.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k + time +
       time*pop_bel_1k + time*pop_1k_2.5k + time*pop_2.5k_10k + time*pop_10k_50k + time*pop_50k_200k +
       med_at_inc + bel_lico + non_cdn + he_highschool + he_postsec + unemp + married +
       marr_w_child + age_15to24 + age_25to34 + age_35to44 + age_45to54 + age_55to64 +
...
#### Renter, no controls
ml.rent1 <- df.no.nas[(df.no.nas$Tenure == "Renter"),] %>% 
  lm(formula = unafford.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k + time +
       time*pop_bel_1k + time*pop_1k_2.5k + time*pop_2.5k_10k + time*pop_10k_50k + time*pop_50k_200k)

#### Renter, w/ controls
ml.rent2 <- df.no.nas[(df.no.nas$Tenure == "Renter"),] %>% 
  lm(formula = unafford.pc ~ pop_bel_1k + pop_1k_2.5k + pop_2.5k_10k + pop_10k_50k + pop_50k_200k + time +
       time*pop_bel_1k + time*pop_1k_2.5k + time*pop_2.5k_10k + time*pop_10k_50k + time*pop_50k_200k +
       med_at_inc + bel_lico + non_cdn + he_highschool + he_postsec + unemp + married +
       marr_w_child + age_15to24 + age_25to34 + age_35to44 + age_45to54 + age_55to64 +
...
stargazer(ml.tot1, ml.tot2, ml.own1, ml.own2, ml.rent1, ml.rent2, 
          align=TRUE,
